...
description: Guidelines and code patterns for using the `netsuite-oauth2-client` package to authenticate with NetSuite REST APIs and RESTlets using OAuth 2.0 Client Credentials.
---
